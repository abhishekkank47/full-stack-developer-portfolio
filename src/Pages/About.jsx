                  ...
                  <div className="border-4 border-blue-300 shadow rounded-lg p-6 h-full">
                    ...
                    <div className="mb-6">
                      ...
                      <p
                        ...
                        style={{ fontFamily: `Winky Sans, sans-serif` }}
                      >
                        Responsible for designing UI and implementing functional
                        frontends and integrating with both NoSQL and SQL
                        databases through backend development. Creating APIs,
                        Calling APIs. Developing and maintain web applications
                        using Technology React.js, Node.js and Express.js,
                        MongoDB, MySQL, PostgreSQL, Framer Motion, Tailwind CSS,
                        Postman, AWS EC2.
                      </p>
                    </div>
                    <div className="mb-6">
                      ...
                      <p
                        ...
                        style={{ fontFamily: `Winky Sans, sans-serif` }}
                      >
                        Awarded "Intern of the Month" and ranked among the Top
                        10 Developers during the internship period. Development
                        of an end-to-end e-commerce platform utilizing MongoDB,
                        Express.js, React.js, and Node.js, Tailwind CSS, Daisy
                        UI Components
                      </p>
                    </div>
                    <div className="mb-6">
                      ...
                      <p
                        ...
                        style={{ fontFamily: `Winky Sans, sans-serif` }}
                      >
                        Developed Websites using HTML5, CSS, JavaScript,
                        Bootstrap Framework and Bootstrap Website Templates
                      </p>
                    </div>
                    <div className="mb-6">
                      <div className="flex justify-between flex-wrap gap-2 w-full">
                      ...
                      >
                        Developed Websites using HTML5, CSS, JavaScript,
                        Bootstrap Framework and Bootstrap Website Templates.
                        Learned about Responsiveness of Website across all
                        Devices. Learned about Domain registration, Domain
                        Hosting Service, C Panel, Word Press
                      </p>
                    </div>
                  </div>
                </div>
